...
export default async function HeaderWrapper() {
    ...
    const links: NavLink[] = [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    label: t("header.links.projects.illustrations"),
                    labels: labelsFor("header.links.projects.illustrations"),
                },
            ],
        },
        {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-surface-80 backdrop-blur-surface border-b border-foreground/10">
